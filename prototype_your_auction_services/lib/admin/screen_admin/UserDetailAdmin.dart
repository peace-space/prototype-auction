...
import 'package:prototype_your_auction_services/channel/UserDetailAdminChannel.dart';
...
class UserDetailAdminState extends State<UserDetailAdmin> {
  ...
  @override
  void dispose() {
    UserDetailAdminChannel.close(id_users: user_detail['id_users']);
    super.dispose();
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: StreamBuilder(
        ...
        stream: UserDetailAdminChannel
            .connent(id_users: user_detail['id_users'])
            .stream,
