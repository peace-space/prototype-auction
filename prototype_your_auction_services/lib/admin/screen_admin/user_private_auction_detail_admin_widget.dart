...
import '../../model/admin_model/ProductDetailModel.dart';
...
class PrivateAuctionDetailAdminWidget extends StatefulWidget {
  State<PrivateAuctionDetailAdminWidget> createState() {
    return PrivateAuctionDetailAdminWidgetState();
  }
}

class PrivateAuctionDetailAdminWidgetState extends State<PrivateAuctionDetailAdminWidget> {
  var _bid = TextEditingController();
  var max_price;
  Map<String, dynamic> detailAuctionData = {};
  List<dynamic> _imageData = [];
  int indexSelectImage = 0;
  PrivateAuctionAdminModel privateAuctionDetailAdminModel = PrivateAuctionAdminModel();
  late Map private_auction_data = privateAuctionDetailAdminModel.getAuctionDetailAdminData();
    ...
    return Scaffold(
      ...
      body: StreamBuilder(
        stream: ProductDetailAdminChannel
            .connectAdmin(id_auctions: private_auction_data['id_auctions'])
            .stream,
