...
class EditBankAccountUserState extends State<EditBankAccountUser> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("แก้ไขข้อมูลบัญชี ${ShareData.userData['id_users']}"),
      ),
      body: ListView(
  ...
  Widget nameBankAccount() {
    return TextField(
      ...
      decoration: InputDecoration(
        labelText: "ชื่อธนาคาร: " + bankAccountUser!['name_bank_account'],
  ...
  Widget nameAccount() {
    return TextField(
      ...
      decoration: InputDecoration(
        labelText: "ชื่อบัญชี: " + bankAccountUser['name_account'],
        border: OutlineInputBorder(),
        hintText: "ชื่อบัญชี",
      ),
      onChanged: (value) {
  ...
  Widget bankAccountNumber() {
    return TextField(
      ...
      decoration: InputDecoration(
        labelText: "เลขบัญชีธนาคาร: " + bankAccountUser['bank_account_number'],
        border: OutlineInputBorder(),
  ...
  Widget promptPay() {
    return TextField(
      ...
      decoration: InputDecoration(
        labelText: "พร้อมเพย์: " + bankAccountUser['prompt_pay'],
        border: OutlineInputBorder(),
        hintText: "อีเมล",
      ),
      onChanged: (value) {
